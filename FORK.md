...
| Bestand                                                                                                     | Wijziging                                                                                                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `src-tauri/src/managers/transcription.rs`                                                                   | `transcribe_remote()` + `encode_wav()`; `transcribe()` en `initiate_model_load()` gaan eerst naar de server als `remote_transcription_enabled` aan staat; bij een fout valt `transcribe()` terug op het lokale model (`remote_transcription_fallback`) |
| `src-tauri/src/settings.rs`                                                                                 | velden `remote_transcription_enabled` / `_url` / `_fallback`; `update_checks_forced_disabled()` geeft altijd `true`                                                                                                                                    |
| `src-tauri/src/shortcut/mod.rs`, `lib.rs`                                                                   | drie `change_remote_transcription_*`-commando's                                                                                                                                                                                                        |
